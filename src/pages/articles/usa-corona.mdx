...
import usaind from '../../assets/images/articles/usa-ind.png';
import usacountry from '../../assets/images/articles/usa-country.png';
import timeforcure from '../../assets/images/articles/time-for-cure.png';

### When the Corona virus Pandemic will end in USA and will solve it?

<Image src={usaind} alt="USA Independence Birth data" width="461" height="216" />

Below is the Sidereal (Vedic) Horoscope of USA declaration of Independence.
<Image src={usacountry} alt="USA Independence Horoscope" width="816" height="1056" />
...
<Image src={timeforcure} alt="USA Independence Horoscope" width="486" height="152" />
